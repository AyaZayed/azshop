  ...
  return (
    <form
      ...
      <div className="flex gap-2">
        ...
        <p className="text-red text-xs">{fields.rating.errors}</p>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        />
        <p className="text-red text-xs">{fields.author.errors}</p>
      </div>
      <div className="flex flex-col gap-2">
        ...
        <Input
          ...
          key={fields.headline.key}
          defaultValue={fields.headline.initialValue}
        />
        <p className="text-red text-xs">{fields.headline.errors}</p>
      </div>
      <div className="flex flex-col gap-2">
        ...
        />
        <p className="text-red text-xs">{fields.content.errors}</p>
      </div>
      <div className="flex gap-2 self-end">
        ...
        <DialogClose asChild className="w-full">
          <SubmitButton label="Submit" userId={userId} />
        </DialogClose>
      </div>
    </form>
  );
